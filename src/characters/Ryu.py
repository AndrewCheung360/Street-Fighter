...
class Ryu(Fighter):
    def __init__(self,mode, playerNum, x,y,direction,*groups):
        ...
        super().__init__(mode, playerNum,'Ryu','assets/graphics/characters/Ryu/ryu_spritesheet.png',"black",x,y,self.idleFrames,self.walkFrames, self.jumpFrames, self.sideJumpFrames, self.crouchFrame,direction,*groups)
