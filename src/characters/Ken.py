...
class Ken(Fighter):
    def __init__(self,mode, playerNum,x,y,direction,*groups):
        self.name = "Ken"
        self.sheet = 'assets/graphics/characters/Ken/ken_spritesheet.png'
        self.statusPortraitFrame = (962,929,21,32)
        ...
        self.jumpLightPunchFrames = ([(380, 547, 31, 67),(416, 554, 39, 53),(104, 547, 31, 67)],[0.0333,0.2,0.133])
        self.jumpMediumPunchFrames = ([(2, 547, 40, 67),(47, 556, 51, 51),(104, 547, 31, 67)],[0.0667,0.2,0.133])
        self.jumpHeavyPunchFrames = ([(2, 547, 40, 67),(47, 556, 51, 51),(104, 547, 31, 67)],[0.0833,0.2,0.133])
        self.jumpLightKickFrames = ([(144, 532, 45, 82),(198, 540, 31, 67)],[0.166,0.2])
        self.jumpMediumKickFrames = ([(144, 532, 45, 82),(198, 540, 31, 67)],[0.216,0.1])
        self.jumpHeavyKickFrames = ([(242, 532, 32, 82),(278, 525, 53, 89),(336,531,34,83),(619,17,29,78),(656,9,33,90)],[0.1,0.0667,0.116,0.0667,0.0667])
        
        self.diagonalJumpLightPunchFrames = ([(380, 547, 31, 67),(416, 554, 39, 53),(104, 547, 31, 67)],[0.0333,0.2,0.133])
        self.diagonalJumpMediumPunchFrames = ([(2, 547, 40, 67),(47, 552, 51, 55),(104, 547, 31, 67)],[0.0667,0.2,0.133])
        self.diagonalJumpHeavyPunchFrames = ([(2, 547, 40, 67),(47, 552, 51, 55),(104, 547, 31, 67)],[0.0833,0.2,0.133])
        self.diagonalJumpLightKickFrames = ([(380, 547, 31, 67),(416, 554, 39, 53),(104, 547, 31, 67)],[0.0333,0.2,0.133])
