...
class Ken(Fighter):
    def __init__(self,mode, playerNum,x,y,direction,*groups):
        ...
        super().__init__(mode, playerNum,'Ken','assets/graphics/characters/Ken/ken_spritesheet.png',"black",x,y,self.idleFrames,self.walkFrames, self.jumpFrames, self.sideJumpFrames, self.crouchFrame, direction,*groups)
